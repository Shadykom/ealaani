// This file contains hardcoded billboard data that will be bundled with the application
// to ensure it's always available in production environments
...
// Export as a constant array to ensure it's bundled with the application
export const BILLBOARD_DATA: Billboard[] = [
  {
    id: "bb-001",
